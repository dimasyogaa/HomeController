package com.yogadimas.homecontroller.receiver.switch4;
...
public class MyReceiverOff4 extends BroadcastReceiver {

    public static final String CHANNEL_ID = "Channel_18";
    public static final String CHANNEL_NAME = "Timer";
    public final static int ID_SWITCH_OFF_4 = 18;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String message = context.getString(R.string.msg_notification_switch_off_4);
    ...
    public void setTimerOff4(Context context, String time) {
        String TIME_FORMAT = "HH:mm";
        if (isDateInvalid(time, TIME_FORMAT)) return;
        String[] timeArray = time.split(":");

        AlarmManager alarmManager = (AlarmManager) context.getSystemService(ALARM_SERVICE);
        Intent intent = new Intent(context, MyReceiverOff4.class);
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, ID_SWITCH_OFF_4, intent, 0);
    ...
    public void cancelTimer(Context context) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(ALARM_SERVICE);
        Intent intent = new Intent(context, MyReceiverOff4.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, ID_SWITCH_OFF_4,
                intent, 0);
        if (alarmManager != null) {
    ...
    private void showReminderNotification(Context context, String title, String message) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, ID_SWITCH_OFF_4, intent,
        ...
        notificationManager.notify(ID_SWITCH_OFF_4, notification);
