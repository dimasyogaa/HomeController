...
public class MyReceiverOn1 extends BroadcastReceiver {

    public static final String CHANNEL_ID = "Channel_11";
    public static final String CHANNEL_NAME = "Timer";
    private final static int ID_SWITCH_ON_1 = 11;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String message = context.getString(R.string.msg_notification_switch_on_1);
    ...
    public void setTimerOn1(Context context, String time) {
        String TIME_FORMAT = "HH:mm";
        if (isDateInvalid(time, TIME_FORMAT)) return;
        String[] timeArray = time.split(":");

        AlarmManager alarmManager = (AlarmManager) context.getSystemService(ALARM_SERVICE);
        Intent intent = new Intent(context, MyReceiverOn1.class);
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, ID_SWITCH_ON_1, intent, 0);
    ...
    public void cancelTimer(Context context) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(ALARM_SERVICE);
        Intent intent = new Intent(context, MyReceiverOn1.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, ID_SWITCH_ON_1,
                intent, 0);
        if (alarmManager != null) {
    ...
    private void showReminderNotification(Context context, String title, String message) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, ID_SWITCH_ON_1, intent,
        ...
        notificationManager.notify(ID_SWITCH_ON_1, notification);
